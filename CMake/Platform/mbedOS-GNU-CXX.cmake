...
set(CMAKE_CXX_LINK_EXECUTABLE       "<CMAKE_CXX_COMPILER> <CMAKE_CXX_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> -Wl,--whole-archive <LINK_LIBRARIES> -Wl,--no-whole-archive -Wl,-z,muldefs -Wl,--start-group -lnosys -lstdc++ -lsupc++ -lm -lc -lgcc -lnosys -lnosys -lstdc++ -lsupc++ -lm -lc -lgcc -lnosys -Wl,--end-group -o <TARGET>")
